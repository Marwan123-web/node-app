...
class teacherService {
    ...
    static addMaterial(courseId, semester_time, materialType, materialPath) {
        var material = { type: materialType, path: materialPath };
        return Course.findOne({ courseCode: courseId }).updateOne(
            { courseCode: courseId, "semesters.semester_time": semester_time }, // your query, usually match by _id
            { $push: { "semesters.$.materials": material } }, // item(s) to match from array you want to pull/remove
            { multi: true } // set this to true if you want to remove multiple elements.
        )
    }
    ...
    static deleteMaterial(courseId, semester_time, materialname) {
        return Course.findOne({ courseCode: courseId }).updateOne(
            { courseCode: courseId, "semesters.semester_time": semester_time }, // your query, usually match by _id
            { $pull: { "semesters.$.materials": { type: materialname } } }, // item(s) to match from array you want to pull/remove
            { multi: true } // set this to true if you want to remove multiple elements.
        )
