...
router.get('/my/posts/:id', adminController.getmyPosts);
...
router.delete('/delete/course/semester/material/:id/:materialname/:semester', TeacherStudentController.deleteSemesterMaterial);
